    ...
    <table class="MainArea_Content" align="center" cellspacing="0" cellpadding="0">
        ...
        <thead>
            <tr align="center" valign="middle" id="TableTitle">
				<td align = "center">菜编号</td>
				<td align = "center">菜名</td>
				<td align = "center">所属菜系</td>
		...
		<!--显示数据列表 -->
        <tbody id="TableData">
	        <c:forEach items="${listFood}" var="food" varStatus="vs">  
		        <tr class="TableDetail1">
		        	 <td align = "center">${vs.index+1 }</td> 
		             <td align = "center">${food.foodName}</td>  
		             <td align = "center">${food.foodTypeName}</td>  
		             <td align = "center">${food.price}</td>  
		             <td align = "center">${food.mprice}</td>
		         	 <td>
						<a href="/hotel/food?method=viewUpdate&id=${food.id }"  class="FunctionButton">更新</a>				
						<a href="/hotel/food?method=delete&id=${food.id }" onClick="return delConfirm();"class="FunctionButton">删除</a>				
					 </td>
		         </tr>  
			</c:forEach>  
        </tbody>
